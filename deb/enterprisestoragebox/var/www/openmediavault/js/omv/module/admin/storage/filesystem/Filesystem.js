...
/**
 * @class ESB.module.admin.storage.filesystem.Create
 * @derived ESB.workspace.window.Form
 */
Ext.define("ESB.module.admin.storage.filesystem.Create", {
	...
	doSubmit: function() {
		...
		ESB.MessageBox.show({
			...
			fn: function(answer) {
				...
				var wnd = Ext.create("ESB.window.Execute", {
					title: _("Create file system"),
...
/**
 * @class ESB.module.admin.storage.filesystem.Quota
 ...
 * Defaults to FALSE.
 */
Ext.define("ESB.module.admin.storage.filesystem.Quota", {
			...
			listeners: {
				...
				validateedit: function(editor, e, eOpts) {
					...
					if (bhardlimit > 4 * Math.pow(2, 40)) {
						ESB.MessageBox.failure(null, _("The specified quota exceeds the max. possible value of 4TiB."));
						return false;
					}
				}
			}
...
/**
 * @class ESB.module.admin.storage.filesystem.Filesystems
 * @derived ESB.workspace.grid.Panel
 */
Ext.define("ESB.module.admin.storage.filesystem.Filesystems", {
	...
	uses: [
		"ESB.module.admin.storage.filesystem.Create",
		"ESB.module.admin.storage.filesystem.Quota"
	],
	...
	onCreateButton: function() {
		var me = this;
		Ext.create("ESB.module.admin.storage.filesystem.Create", {
			listeners: {
				scope: me,
				submit: function() {
					this.doReload();
	...
	onQuotaButton: function() {
		var me = this;
		var record = me.getSelected();
		Ext.create("ESB.module.admin.storage.filesystem.Quota", {
...
ESB.WorkspaceManager.registerPanel({
	...
	text: _("File Systems"),
	position: 10,
	className: "ESB.module.admin.storage.filesystem.Filesystems"
});
