...
/**
 * @class ESB.module.admin.system.powermanagement.schedule.Job
 * @derived ESB.workspace.window.Form
 */
Ext.define("ESB.module.admin.system.powermanagement.schedule.Job", {
...
/**
 * @class ESB.module.admin.system.powermanagement.schedule.Jobs
 * @derived ESB.workspace.grid.Panel
 */
Ext.define("ESB.module.admin.system.powermanagement.schedule.Jobs", {
	...
	uses: [
		"ESB.module.admin.system.powermanagement.schedule.Job"
	],
	...
	onAddButton: function() {
		var me = this;
		Ext.create("ESB.module.admin.system.powermanagement.schedule.Job", {
...
ESB.WorkspaceManager.registerPanel({
	...
	position: 20,
	className: "ESB.module.admin.system.powermanagement.schedule.Jobs"
});
