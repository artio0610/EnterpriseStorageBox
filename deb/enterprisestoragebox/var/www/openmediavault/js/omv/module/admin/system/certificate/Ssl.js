...
/**
 * @class ESB.module.admin.system.certificate.ssl.Create
 * @derived ESB.workspace.window.Form
 */
Ext.define("ESB.module.admin.system.certificate.ssl.Create", {
...
/**
 * @class ESB.module.admin.system.certificate.ssl.Edit
 * @derived ESB.workspace.window.Form
 */
Ext.define("ESB.module.admin.system.certificate.ssl.Edit", {
	extend: "ESB.workspace.window.Form",
	requires: [
...
/**
 * @class ESB.module.admin.system.certificate.ssl.Detail
 * @derived ESB.workspace.window.TextArea
 */
Ext.define("ESB.module.admin.system.certificate.ssl.Detail", {
...
/**
 * @class ESB.module.admin.system.certificate.ssl.Certificates
 * @derived ESB.workspace.grid.Panel
 * Display list of installed SSL certificates.
 */
Ext.define("ESB.module.admin.system.certificate.ssl.Certificates", {
	...
	uses: [
		"ESB.module.admin.system.certificate.ssl.Edit",
		"ESB.module.admin.system.certificate.ssl.Create",
		"ESB.module.admin.system.certificate.ssl.Detail"
	],
	...
	onAddButton: function(action) {
		...
		switch(action) {
		case "import":
			className = "ESB.module.admin.system.certificate.ssl.Edit";
			title = _("Import SSL certificate");
			break;
		case "create":
			className = "ESB.module.admin.system.certificate.ssl.Create";
	...
	onEditButton: function() {
		...
		Ext.create("ESB.module.admin.system.certificate.ssl.Edit", {
	...
	onDetailButton: function() {
		var me = this;
		var record = me.getSelected();
		Ext.create("ESB.module.admin.system.certificate.ssl.Detail", {
			rpcGetParams: {
				uuid: record.get("uuid")
			}
		}).show();
...
ESB.WorkspaceManager.registerPanel({
	...
	text: _("SSL"),
	position: 20,
	className: "ESB.module.admin.system.certificate.ssl.Certificates"
});
