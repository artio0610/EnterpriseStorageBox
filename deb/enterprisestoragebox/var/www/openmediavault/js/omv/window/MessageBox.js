			...
			buttons: [{
				...
				handler: function(c, e) {
					...
					if(!Ext.isEmpty(error.trace))
						text += error.trace;
					details.update(ESB.util.Format.whitespace(
...
*/
	...
	/**
	 * @class ESB.MessageBox
	 * @derived ESB.window.MessageBox
	 * @singleton
	 * Singleton instance of {@link ESB.window.MessageBox}.
	 */
	ESB.MessageBox = ESB.Msg = new this();
});
