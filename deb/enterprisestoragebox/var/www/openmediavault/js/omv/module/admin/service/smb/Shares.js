...
/**
 * @class ESB.module.admin.service.smb.Share
 * @derived ESB.workspace.window.Form
 */
Ext.define("ESB.module.admin.service.smb.Share", {
...
/**
 * @class ESB.module.admin.service.smb.Shares
 * @derived ESB.workspace.grid.Panel
 */
Ext.define("ESB.module.admin.service.smb.Shares", {
	...
	uses: [
		"ESB.module.admin.service.smb.Share"
	],
	...
	onAddButton: function() {
		var me = this;
		Ext.create("ESB.module.admin.service.smb.Share", {
			title: _("Add share"),
...
ESB.WorkspaceManager.registerPanel({
	...
	text: _("Shares"),
	position: 20,
	className: "ESB.module.admin.service.smb.Shares"
});
