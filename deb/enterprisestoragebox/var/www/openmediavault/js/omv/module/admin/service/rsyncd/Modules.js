...
/**
 * @class ESB.module.admin.service.rsyncd.module.General
 * @derived ESB.form.Panel
 */
Ext.define("ESB.module.admin.service.rsyncd.module.General", {
...
/**
 * @class ESB.module.admin.service.rsyncd.module.AuthUser
 * @derived ESB.workspace.window.Form
 */
Ext.define("ESB.module.admin.service.rsyncd.module.AuthUser", {
...
/**
 * @class ESB.module.admin.service.rsyncd.module.AuthUsers
 * @derived ESB.workspace.grid.Panel
 */
Ext.define("ESB.module.admin.service.rsyncd.module.AuthUsers", {
	...
	uses: [
		"ESB.module.admin.service.rsyncd.module.AuthUser"
	],
	...
	onAddButton: function() {
		var me = this;
		Ext.create("ESB.module.admin.service.rsyncd.module.AuthUser", {
			title: _("Add user"),
			listeners: {
				scope: me,
				submit: function(wnd, values) {
					...
					if(this.store.findExact("name", values.name) != -1) {
						ESB.MessageBox.failure(null, "User already exists.");
						return;
					}
	...
	onEditButton: function() {
		...
		var wnd = Ext.create("ESB.module.admin.service.rsyncd.module.AuthUser", {
			title: _("Edit user"),
			listeners: {
				scope: me,
				submit: function(wnd, values) {
...
/**
 * @class ESB.module.admin.service.rsyncd.Module
 * @derived ESB.workspace.window.Tab
 */
Ext.define("ESB.module.admin.service.rsyncd.Module", {
	extend: "ESB.workspace.window.Tab",
	requires: [
		"ESB.module.admin.service.rsyncd.module.General",
		"ESB.module.admin.service.rsyncd.module.AuthUsers",
	...
	getTabItems: function() {
		var me = this;
		return [
			Ext.create("ESB.module.admin.service.rsyncd.module.General", {
				uuid: me.uuid
			}),
			Ext.create("ESB.module.admin.service.rsyncd.module.AuthUsers")
		];
	},
...
/**
 * @class ESB.module.admin.service.rsyncd.Modules
 * @derived ESB.workspace.grid.Panel
 */
Ext.define("ESB.module.admin.service.rsyncd.Modules", {
	extend: "ESB.workspace.grid.Panel",
	requires: [
		"ESB.Rpc",
		"ESB.data.Store",
	...
	uses: [
		"ESB.module.admin.service.rsyncd.Module"
	],
	...
	onAddButton: function() {
		var me = this;
		Ext.create("ESB.module.admin.service.rsyncd.Module", {
			title: _("Add module"),
