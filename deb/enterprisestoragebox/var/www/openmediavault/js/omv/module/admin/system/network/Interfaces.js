...
// require("js/esb/toolbar/Tip.js")

/**
 * @class ESB.module.admin.system.network.interface.window.Generic
 * @derived ESB.workspace.window.Form
 */
Ext.define("ESB.module.admin.system.network.interface.window.Generic", {
...
/**
 * @class ESB.module.admin.system.network.interface.window.Ethernet
 * @derived ESB.module.admin.system.network.interface.window.Generic
 */
Ext.define("ESB.module.admin.system.network.interface.window.Ethernet", {
	extend: "ESB.module.admin.system.network.interface.window.Generic",
...
/**
 * @class ESB.module.admin.system.network.interface.window.Bond
 * @derived ESB.module.admin.system.network.interface.window.Generic
 */
Ext.define("ESB.module.admin.system.network.interface.window.Bond", {
	extend: "ESB.module.admin.system.network.interface.window.Generic",
	uses: [
		"ESB.form.field.CheckboxGrid"
	],
...
/**
 * @class ESB.module.admin.system.network.interface.window.Vlan
 * @derived ESB.module.admin.system.network.interface.window.Generic
 */
Ext.define("ESB.module.admin.system.network.interface.window.Vlan", {
	extend: "ESB.module.admin.system.network.interface.window.Generic",
...
/**
 * @class ESB.module.admin.system.network.interface.window.Wireless
 * @derived ESB.module.admin.system.network.interface.window.Generic
 */
Ext.define("ESB.module.admin.system.network.interface.window.Wireless", {
	extend: "ESB.module.admin.system.network.interface.window.Generic",
	requires: [
...
/**
 * @class ESB.module.admin.system.network.interface.Identify
 * @derived ESB.workspace.window.Form
 * @param devicename The name of the network interface device, e.g. eth0.
 */
Ext.define("ESB.module.admin.system.network.interface.Identify", {
	extend: "ESB.workspace.window.Form",
	uses: [
		"ESB.window.Execute",
		"ESB.toolbar.Tip"
		...
		Ext.create("ESB.window.Execute", {
			...
			listeners: {
				...
				finish: function(c) {
					...
					c.close();
					if(value.length > 0) {
						ESB.MessageBox.error(null, value);
					}
				},
...
/**
 * @class ESB.module.admin.system.network.interface.Interfaces
 * @derived ESB.workspace.grid.Panel
 */
Ext.define("ESB.module.admin.system.network.interface.Interfaces", {
	...
	requires: [
		...
		"ESB.data.proxy.Rpc",
		"ESB.util.Format",
		"ESB.module.admin.system.network.interface.Identify",
		"ESB.module.admin.system.network.interface.window.Ethernet",
		"ESB.module.admin.system.network.interface.window.Bond",
		"ESB.module.admin.system.network.interface.window.Vlan"
	],
	uses: [
		"Ext.XTemplate"
	],
	...
	onSelectionChange: function(model, records) {
		...
		// configuration (uuid !== ESB.UUID_UNDEFINED).
		if (records.length <= 0) {
			// Nothing to do here.
	...
	onAddButton: function(type) {
		...
		switch (type) {
		case "ethernet":
			clsName = "ESB.module.admin.system.network.interface.window.Ethernet";
			title = _("Add ethernet connection");
			break;
		case "bond":
			clsName = "ESB.module.admin.system.network.interface.window.Bond";
			title = _("Add bond connection");
			break;
		case "vlan":
			clsName = "ESB.module.admin.system.network.interface.window.Vlan";
			title = _("Add VLAN connection");
			break;
		case "wireless":
			clsName = "ESB.module.admin.system.network.interface.window.Wireless";
			title = _("Add Wi-Fi connection");
			break;
		default:
			ESB.MessageBox.error(null, _("Unknown network interface type."));
			break;
		}
	...
	onIdentifyButton: function() {
		var me = this;
		var record = me.getSelected();
		Ext.create("ESB.module.admin.system.network.interface.Identify", {
...
ESB.WorkspaceManager.registerPanel({
	...
	text: _("Interfaces"),
	position: 20,
	className: "ESB.module.admin.system.network.interface.Interfaces"
});
