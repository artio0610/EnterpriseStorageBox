...
/**
 * @class ESB.module.user.privilege.user.User
 * @derived ESB.workspace.form.Panel
 */
Ext.define("ESB.module.user.privilege.user.User", {
	extend: "ESB.workspace.form.Panel",
	requires: [
		"ESB.workspace.form.Panel",
...
ESB.WorkspaceManager.registerPanel({
	...
	text: _("User"),
	position: 10,
	className: "ESB.module.user.privilege.user.User"
});
