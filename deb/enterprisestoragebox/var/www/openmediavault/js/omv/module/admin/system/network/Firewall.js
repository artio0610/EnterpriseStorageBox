...
/**
 * @class ESB.module.admin.system.network.firewall.Rule
 * @derived ESB.workspace.window.Form
 * @param family The address family, e.g. 'inet' or 'inet6'. Defaults
 *   to 'inet'.
 */
Ext.define("ESB.module.admin.system.network.firewall.Rule", {
...
/**
 * @class ESB.module.admin.system.network.firewall.Rules
 * @derived ESB.workspace.grid.Panel
 * @param family The address family, e.g. 'inet' or 'inet6'. Defaults
 *   to 'inet'.
 */
Ext.define("ESB.module.admin.system.network.firewall.Rules", {
	...
	requires: [
		...
		"ESB.data.Model",
		"ESB.data.proxy.Rpc",
		"ESB.module.admin.system.network.firewall.Rule"
	],
...
*/
	...
	onAddButton: function() {
		var me = this;
		Ext.create("ESB.module.admin.system.network.firewall.Rule", {
	...
	onEditButton: function() {
		...
		var wnd = Ext.create("ESB.module.admin.system.network.firewall.Rule", {
...
ESB.WorkspaceManager.registerPanel({
	...
	text: _("Firewall"),
	position: 60,
	className: "ESB.module.admin.system.network.firewall.Rules"
});
