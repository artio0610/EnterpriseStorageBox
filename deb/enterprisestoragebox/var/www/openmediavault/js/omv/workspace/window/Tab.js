 ...
 */
// require("js/esb/workspace/window/Container.js")
// require("js/esb/tab/Panel.js")

/**
 * @ingroup webgui
 * A workspace window displaying a tab panel.
 * @class ESB.workspace.window.Tab
 * @derived ESB.workspace.window.Container
 */
Ext.define("ESB.workspace.window.Tab", {
	extend: "ESB.workspace.window.Container",
	requires: [
		"ESB.tab.Panel"
	],

	tabClassName: "ESB.tab.Panel",
