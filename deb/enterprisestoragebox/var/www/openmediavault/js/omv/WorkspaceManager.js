 ...
 */
// require("js/esb/workspace/node/Node.js")

/**
 * @ingroup webgui
 * @class ESB.WorkspaceManager
 */
Ext.define("ESB.WorkspaceManager", {
	singleton: true,
	requires: [
	...
	createNode: function(config) {
		return ESB.workspace.node.Node.create(config);
	},
	...
	explodeNodePath: function(path) {
		return ESB.workspace.node.Node.explodeUri(path);
	},
	...
	buildNodePath: function(parts) {
		return ESB.workspace.node.Node.buildUri(parts);
	},
