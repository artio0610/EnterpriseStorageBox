...
/**
 * @ingroup webgui
 * @class ESB.form.SslCertificateComboBox
 ...
 */
Ext.define("ESB.form.field.SslCertificateComboBox", {
	...
	onTrigger2Click: function() {
		...
		if (!Ext.isUUID(uuid))
			return;
		Ext.create("ESB.workspace.window.TextArea", {
