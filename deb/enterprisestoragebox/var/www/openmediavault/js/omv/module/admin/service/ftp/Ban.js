...
/**
 * @class ESB.module.admin.service.ftp.BanRule
 * @derived ESB.workspace.window.Form
 */
Ext.define("ESB.module.admin.service.ftp.BanRule", {
...
/**
 * @class ESB.module.admin.service.ftp.BanRules
 * @derived ESB.workspace.grid.Panel
 */
Ext.define("ESB.module.admin.service.ftp.BanRules", {
	...
	uses: [
		"ESB.module.admin.service.ftp.BanRule"
	],
	...
	onAddButton: function() {
		var me = this;
		Ext.create("ESB.module.admin.service.ftp.BanRule", {
			title: _("Add rule"),
...
ESB.WorkspaceManager.registerPanel({
	...
	text: _("Ban list"),
	position: 30,
	className: "ESB.module.admin.service.ftp.BanRules"
});
