...
// require("js/esb/form/plugin/LinkedFields.js")
// require("js/esb/form/field/plugin/FieldInfo.js")

/**
 * @ingroup webgui
 * @class ESB.workspace.form.Panel
 ...
 */
Ext.define("ESB.workspace.form.Panel", {
	extend: "ESB.form.Panel",
	requires: [
		"ESB.Rpc",
		"ESB.form.CompositeField",
		"ESB.form.plugin.LinkedFields",
		"ESB.form.field.plugin.FieldInfo"
	],
	uses: [
