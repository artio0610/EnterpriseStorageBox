		...
		return {
			...
			booleanRenderer: function() {
				return function(value) {
					return ESB.util.Format.boolean(value);
				};
			},
			...
			whitespaceRenderer: function(mode) {
				return function(value) {
					return ESB.util.Format.whitespace(value, mode);
				};
			},
			...
			binaryUnitRenderer: function() {
				return function(value) {
					return ESB.util.Format.binaryUnit(value);
				};
			},
