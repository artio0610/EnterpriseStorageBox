...
/**
 * @class ESB.module.admin.diagnostic.log.plugin.ftp.Xferlog
 * @derived ESB.module.admin.diagnostic.log.plugin.Plugin
 * Class that implements the 'FTP' logfile diagnostics plugin.
 */
Ext.define("ESB.module.admin.diagnostic.log.plugin.ftp.Xferlog", {
	extend: "ESB.module.admin.diagnostic.log.plugin.Plugin",
	alias: "esb.plugin.diagnostic.log.xferlog",
