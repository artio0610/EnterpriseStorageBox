...
// require("js/esb/grid/column/BooleanIcon.js")
// require("js/esb/grid/column/BooleanText.js")
// require("js/esb/grid/column/CronScheduling.js")
// require("js/esb/grid/column/Empty.js")
// require("js/esb/grid/column/Hyperlink.js")
// require("js/esb/grid/column/UnixTimestamp.js")
// require("js/esb/grid/column/WhiteSpace.js")
// require("js/esb/grid/column/Map.js")
// require("js/esb/grid/column/ToolTip.js")
// require("js/esb/window/MessageBox.js")

/**
 * @ingroup webgui
 * @class ESB.workspace.grid.Panel
...
Ext.define("ESB.workspace.grid.Panel", {
	...
	startDeletion: function(records) {
		...
		ESB.MessageBox.progress("", me.deletionWaitMsg, "");
	...
	onDeletion: function(id, success, response) {
		...
		if (!success) {
			...
			if(me.delActionInfo.records.length > 0) {
				...
				ESB.MessageBox.updateProgress(1, _("100% completed ..."));
				ESB.MessageBox.hide();
				// Execute the post deletion action.
				me.afterDeletion(success);
			}
	...
	updateDeletionProgress: function() {
		...
		// Update progress dialog
		ESB.MessageBox.updateProgress(p, text);
	},
