...
/**
 * @class ESB.module.admin.diagnostic.system.Report
 * @derived ESB.workspace.panel.Textarea
 */
Ext.define("ESB.module.admin.diagnostic.system.Report", {
...
ESB.WorkspaceManager.registerPanel({
	...
	text: _("Report"),
	position: 90,
	className: "ESB.module.admin.diagnostic.system.Report"
});
