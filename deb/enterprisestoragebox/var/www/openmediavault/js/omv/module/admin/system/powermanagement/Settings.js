...
/**
 * @class ESB.module.admin.system.powermanagement.Settings
 * @derived ESB.workspace.form.Panel
 */
Ext.define("ESB.module.admin.system.powermanagement.Settings", {
...
ESB.WorkspaceManager.registerPanel({
	...
	text: _("Settings"),
	position: 10,
	className: "ESB.module.admin.system.powermanagement.Settings"
});
