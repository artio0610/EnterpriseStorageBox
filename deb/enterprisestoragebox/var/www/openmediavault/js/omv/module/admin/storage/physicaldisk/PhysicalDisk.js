...
/**
 * @class ESB.module.admin.storage.physicaldisk.Settings
 ...
 */
Ext.define("ESB.module.admin.storage.physicaldisk.Settings", {
...
/**
 * @class ESB.module.admin.storage.physicaldisk.Devices
 * @derived ESB.workspace.grid.Panel
 */
Ext.define("ESB.module.admin.storage.physicaldisk.Devices", {
	...
	uses: [
		"ESB.module.admin.storage.physicaldisk.Settings",
	...
	onEditButton: function() {
		...
		Ext.create("ESB.module.admin.storage.physicaldisk.Settings", {
			uuid: Ext.isObject(hdparm) ? hdparm.uuid : ESB.UUID_UNDEFINED,
	...
	onScanButton: function() {
		var me = this;
		ESB.MessageBox.wait(null, _("Scanning for new devices ..."));
...
ESB.WorkspaceManager.registerPanel({
	...
	text: _("Devices"),
	position: 10,
	className: "ESB.module.admin.storage.physicaldisk.Devices"
});
