...
/**
 * @class ESB.module.admin.service.rsync.Job
 * @derived ESB.workspace.window.Form
 */
Ext.define("ESB.module.admin.service.rsync.Job", {
	...
	updateFormFields: function() {
		...
		if(this.uuid !== ESB.UUID_UNDEFINED) {
...
/**
 * @class ESB.module.admin.service.rsync.Jobs
 * @derived ESB.workspace.grid.Panel
 */
Ext.define("ESB.module.admin.service.rsync.Jobs", {
	...
	uses: [
		"ESB.module.admin.service.rsync.Job"
	],
	...
	onAddButton: function() {
		...
		Ext.create("ESB.module.admin.service.rsync.Job", {
...
ESB.WorkspaceManager.registerPanel({
	...
	text: _("Jobs"),
	position: 10,
	className: "ESB.module.admin.service.rsync.Jobs"
});
